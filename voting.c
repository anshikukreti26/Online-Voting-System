...
int main()
{
    ...
    printf("\tPlease enter one(1) to see further options\n\n\n");
    int BB;
    scanf("%d",&BB);
    if(BB==1)
    {
...
int *z;
 z = &UNIVERSAL;
     ...
     system("cls");
     printf("\n\n\n\n");
     printf("\t You can caste your vote only if your Aadhar ID, Name and Date of Birth matches.\n\n");
     Sleep(300);
     printf("\t\t\tThe Portal will be closed automatically if you get your details wrong %d times.\n\n\n",R);
     Sleep(300);
     printf("\t\tPlease \n");
     Sleep(300);
     ...
     while(temp!=NULL)
     {
         ...
         printf("\n\n\n\n");
         printf("\tIncorrect Aadhar ID/ Name/ Date of Birth\n\n");
         Sleep(300);
         printf("\t\t\tPlz Re-Enter\n\n");
         Sleep(300);
         system("pause");
